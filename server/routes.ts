  ...
  if (galleryCount.count === 0) {
    await db.insert(galleryItems).values([
      ...
      },
      {
        ...
        category: "Countertops",
        beforeImage: "/images/utility-before-drywall.jpg",
      ...
      {
        title: "Exposed Brick Powder Room",
        category: "Custom Builds",
        beforeImage: "/images/brick-powder-room-before.jpg",
        afterImage: "/images/brick-powder-room-after.jpg",
        description: "Charming exposed brick accent wall powder room with recessed medicine cabinet, industrial-style light fixture, and minimalist wall-mount sink. The raw brick adds character while clean grey paint keeps it modern.",
        featured: true,
      },
      {
        title: "Quartz Kitchen Island & Countertops",
        category: "Countertops",
        beforeImage: "/images/kitchen-quartz-waterfall.jpg",
