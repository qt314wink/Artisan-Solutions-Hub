    ...
    <div className="min-h-screen pt-16 bg-background">
      ...
      <section className="bg-charcoal-dark text-white py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <Link href="/articles">
            <a className="inline-flex items-center gap-2 text-white/60 hover:text-white text-sm mb-8 transition-colors" data-testid="link-back-articles">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: article.content
                .replace(/^# (.+)$/gm, '<h1 class="font-display">$1</h1>')
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {related.map((a) => (
                  <Link key={a.id} href={`/articles/${a.slug}`}>
                    <a className="block p-6 rounded-lg border border-border bg-card hover-elevate transition-all group" data-testid={`related-article-${a.id}`}>
