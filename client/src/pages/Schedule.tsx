...
import { Video, CheckCircle2, ExternalLink, Clock, Calendar, Home, ChevronRight } from "lucide-react";
...
const services = [
  "Moving Day Peace of Mind ($300–$800)",
  "Home Office / Workout Room ($500–$1,800)",
  "Entertainment & Sound System ($850–$2,500)",
  "Bathroom Renovation ($1,200–$5,000+)",
  "Kitchen Transformation ($2,000–$8,000+)",
  "Basement Conversion ($3,500–$12,000+)",
  "Lighting & Electrical",
  "Custom Tile, Brick & Stone Work",
  "Epoxy & Custom Finishes",
  "Paint, Wallpaper & Flooring",
  "Windows, Blinds & Shutters",
  "Built-Ins & Organization",
